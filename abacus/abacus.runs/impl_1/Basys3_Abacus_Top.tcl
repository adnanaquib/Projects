...
set rc [catch {
  ...
  open_checkpoint D:/Xilinx/Projects/abacus/abacus.runs/impl_1/Basys3_Abacus_Top.dcp
  ...
  set_property ip_repo_paths d:/Xilinx/Projects/abacus/abacus.cache/ip [current_project]
  set_property ip_output_repo d:/Xilinx/Projects/abacus/abacus.cache/ip [current_project]
...
set rc [catch {
  ...
  catch { report_clock_utilization -file Basys3_Abacus_Top_clock_utilization_routed.rpt }
...
set rc [catch {
  ...
  catch { write_sysdef -hwdef Basys3_Abacus_Top.hwdef -bitfile Basys3_Abacus_Top.bit -meminfo Basys3_Abacus_Top.mmi -ltxfile debug_nets.ltx -file Basys3_Abacus_Top.sysdef }
